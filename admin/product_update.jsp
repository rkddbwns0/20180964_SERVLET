                ...
                <div class = "col-sm-8">
                    <form name = "newProduct" action = "product_update_process.jsp" class = "form-horizontal" method = "post" enctype = "multipart/form-data">
                        ...
                        <div class = "form-group row">
                            ...
                            <div class = "col-sm-3">
                                <input type = "text" id = "unitInStock" name = "unitsInStock" class = "form-control" value = "<%=rs.getString("p_unitsInStock")%>">
                            </div>
                        </div>
                        ...
                        <div class = "form-group row">
                            ...
                            <div class = "col-sm-5">
                                <input type = "radio" id = "radio" name = "condition" value = "New "> 신규 제품 <input type = "radio" name = "condition" value = "Old"> 중고 제품
                                <input type = "radio" id = "radio" name = "condition" value = "Refurbished"> 재생 제품
                            </div>
                        </div>
