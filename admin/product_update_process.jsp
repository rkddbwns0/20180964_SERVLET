...
<%	
    String filename = "";
    String realFolder = request.getServletContext().getRealPath("img/product"); // 웹 애플리케이션상의 절대 경로
    ...
    if (rs.next()) {
        if (fileName != null) {
            ...
            sql = "UPDATE product SET p_name = ?, p_unitPrice = ?, p_description = ?, p_manufacturer = ?, p_unitsInStock = ?, p_condition = ?, p_fileName = ? WHERE p_id = ?";
